...
import prediction_model.processing.prepocessing as pp
import prediction_model.pipeline as pipe 

# Perform train pipeline
def perform_training():
    dataset = load_dataset(file_name=config.FILE_NAME)
    X,y = separate_data(data=dataset)
